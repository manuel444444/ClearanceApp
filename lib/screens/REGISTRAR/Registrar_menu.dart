...
class Menu_Registrar extends StatefulWidget {

  final String StudentID;
  const Menu_Registrar({super.key,required this.StudentID});

  @override
  State<Menu_Registrar> createState() => _Menu_RegistrarState();
}

class _Menu_RegistrarState extends State<Menu_Registrar> {
  @override
